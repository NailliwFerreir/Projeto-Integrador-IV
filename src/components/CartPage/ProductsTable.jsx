        ...
        <table className="w-full text-sm text-left text-gray-500 dark:text-gray-400">
          <tbody>
            ...
            {cartProduct?.length > 0 && cartProduct.map((carts, index) => (
              <tr className="bg-white border-b hover:bg-gray-50" key={carts.id} >
                ...
                <td className="text-center py-4 px-2">
                  <div className=" flex justify-center items-center">
                    <span className="text-[15px] font-normal">{carts.race}</span>
                  </div>
                </td>
                <td className="text-center py-4 px-2">
                  <div className="flex space-x-1 items-center justify-center">
                    <span className="text-[15px] font-normal">{carts.category}</span>
                  </div>
                </td>
                <td className="text-center py-4 px-2">
                  <div className="flex space-x-1 items-center justify-center">
                    <span className="text-[15px] font-normal">R$ {carts.value}</span>
                  </div>
                </td>
                <td className=" py-4">
                  <div className="flex justify-center items-center">
                ...
                <td className="text-right py-4">
                  <div className="flex space-x-1 items-center justify-center">
                    <span className="text-[15px] font-normal">quantidade * preço</span>
                  </div>
                </td>
                <td className="text-right py-4">
                  <div className="flex space-x-1 items-center justify-center">
            ...
            <div className=" flex justify-between mb-6">
              ...
              <p className="text-[15px] font-medium text-qred">R$ {totalValue}</p>
            </div>
